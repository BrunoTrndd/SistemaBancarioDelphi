...
interface
uses SysUtils,uPROGRAMA;
type
  TProduto = class(TPrograma)
...
begin
  Result:= '---------------------- PRODUTO ----------------------'                               + sLineBreak +
           ...
           'Juros Acréscimo: '                + FormatCurr('#.##0,00',FJurosAcrescimo)           + sLineBreak +
           ...
           'Taxa de Administracao: '          + FormatCurr('#.##0,00',FTaxaAdministracao)        + sLineBreak +
           'Data Encerramento: '              + FormatDateTime('mm-yyyy', FDataEncerramento)     + sLineBreak +
           '-----------------------------------------------------'                               + sLineBreak;
end;
